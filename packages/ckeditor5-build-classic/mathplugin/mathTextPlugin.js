...
// import html from '../mathplugin/mathModal/index.html';
let iframeObj;
let html = path.dirname( '../mathModal/index.html' );

const imageIcon = '<?xml version="1.0" encoding="iso-8859-1"?> <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"> <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 190 190" style="enable-background:new 0 0 190 190;" xml:space="preserve"> <path d="M3.53,0h182.94v44.78h-32.439V32.439H73.017L125.42,95l-52.403,62.561h81.015V145.22h32.439V190H3.53l79.574-95L3.53,0z"/> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> </svg>';
...
export default class MathText extends Plugin {
	init() {
		...
		this.listenTo( editor.editing.view.document, 'dblclick', ( evt, data ) => {
			const ifrm = document.getElementById( 'mathModalIframe' );
	...
	_editorToPopupdoubleClickHandler( element, event ) {
		const latexStr = decodeURIComponent( element.getAttribute( 'data-mathtext' ) );
		...
		this._defineEquationWriter( { latex: latexStr, advanced } );
	}
}
